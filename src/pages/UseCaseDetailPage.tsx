        ...
        <Layout>
            <div className="max-w-screen-xl xl:mx-auto py-[40px] mx-4">
                ...
                <div className="md:space-y-10 space-y-5">
                    <div>
                        <h1 className="text-secondary md:text-[52px] text-[32px] font-extrabold">
                            Leveraging NFT-based Royalty Programs for an Automotive Aftermarket Parts Manufacturer
                        </h1>
                    </div>
                    <div>
                        <img src="/images/gas_station.svg" className="md:h-[500px] w-full rounded-[40px] object-cover object-center" />
                    </div>
                </div>

...
export default function TeamComponent({ heading, img, content }: Props) {
    return (
        <div className="md:flex md:flex-row flex-col border border-tersioarysolid rounded-[40px] md:h-[300px]">
            ...
            <div className="md:border-l md:border-t-0 border-t md:pl-[30px] pl-4 md:pr-[40px] pr-[22px] border-tersioarysolid w-full flex flex-col md:py-[30px] py-[10px] space-y-[10px]">

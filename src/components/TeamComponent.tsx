...
export default function TeamComponent({ heading, img, content }: Props) {
    return (
        <div className="md:flex md:flex-row flex-col border border-tersioarysolid md:rounded-[40px] rounded-[20px] md:h-[300px]">
            <div className="md:w-1/2 flex items-center justify-center md:py-0 py-5">
                <img src={img} width={240} height={240} className="rounded-full w-auto object-contain h-[240px] aspect-square lg:px-0 md:px-2" />
            </div>
